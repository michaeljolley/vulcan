...
module.exports = async function(context, req) {
  ...
  const message =
    "Hey, we're a friendly bunch here, but we do ask that you abide by our code of conduct, which can be found here: https://baldbeardedbuilder.com/code-of-conduct";
